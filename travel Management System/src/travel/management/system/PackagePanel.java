...
public class PackagePanel extends JPanel implements ActionListener{
    ...
    public void createtablemodel()
	{
		 ...
		 table.getColumnModel().getColumn(0).setMaxWidth(290);
		 table.getColumnModel().getColumn(1).setMaxWidth(290);
                 table.getColumnModel().getColumn(2).setMaxWidth(290);
                 table.getColumnModel().getColumn(3).setMaxWidth(290);
            } catch(Exception ae){}
